...
export const centers: Center[] = [
  ...
  },
  {
    ...
    address: "Tanguiéta, Atakora",
    city: "Tanguiéta",
    postalCode: "07 BP",
    lat: 10.6210,
    lng: 1.2470,
    phone: "+229 23 73 20 30",
    email: "transfusion-tangujeta@sante.bj",
    hours: [
      { jours: "Lundi - Vendredi", horaires: "07h00 - 13h00" },
  ...
  {
    id: 8,
    name: "Centre Hospitalier Universitaire Mother & Child de Cotonou",
    nature: "Unité hospitalière",
    address: "Avenue Cincinnatus Leconte, Cotonou",
    city: "Cotonou",
    postalCode: "01 BP",
    lat: 6.3840,
    lng: 2.4320,
    phone: "+229 21 30 22 44",
    email: "chu-mere-enfant@sante.bj",
    hours: [
      { jours: "Lundi - Vendredi", horaires: "07h30 - 16h00" },
      { jours: "Samedi", horaires: "08h00 - 13h00" },
      { jours: "Dimanche", horaires: "Fermé" },
    ],
    isOpen: true,
    donationTypes: ["sang_total", "plaquettes"],
    appointmentRequired: false,
  },
  {
    id: 9,
